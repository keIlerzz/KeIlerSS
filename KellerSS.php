  ...
  $$$$$$$$$$\"\"\"\"           \"\"$$$$$$$$$$$\"
   \"$$$$$\"                      \"\"$$$$\"\"\"
     \"$$$\"                         $$$$\"
           ...
           AucerolaSS & KellerSS & SheikSS
           Android Fucking Cheaters
           discord.gg/nocrycommunity
                    ...
                    \e[36m{C} Coded By - AucerolaSS | KellerSS | SheikSS                                  
\e[32m
  \n";
}
...
function verificarAcessoUso() {
    ...
    if (empty(trim($resultadoUsageStats))) {
...
function verificarGerenciadoresArquivos() {
    ...
    if (!empty(trim($resultadoTodosApps))) {
...
function verificarPermissoesSuspeitas() {
    ...
    if (!empty(trim($resultadoAppsComPermissao))) {
...
function verificarModulosMagisk() {
    ...
    if (!empty(trim($resultadoMagiskModules))) {
...
function verificarProcessosSuspeitos() {
    ...
    if (!empty(trim($resultadoTodosProcessos))) {
...
function verificarArquivosSuspeitos() {
    ...
    if (!empty(trim($resultadoBuscaArquivos))) {
...
function verificarTweaksPerformance() {
    ...
    if (!empty(trim($resultadoScriptsInit))) {
...
function verificarVirtualizacao() {
    ...
    if (strpos($resultadoCpuInfo, 'qemu') !== false || strpos($resultadoCpuInfo, 'virtualbox') !== false) {
